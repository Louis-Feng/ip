...
public class Level7 {
    public static void main(String[] args) throws IOException {
        ...
        FileInputStream fis=new FileInputStream("D:/ip/src/main/data/duke.txt");
        Scanner sc=new Scanner(fis);
        FileWriter writer = new FileWriter("D:/ip/src/main/data/duke.txt");
        ...
        for (int i = 0; i < task.size(); i++) {
            ...
            if(task.get(i) instanceof Todo){
                writer.write("todo " +task.get(i).description);}
